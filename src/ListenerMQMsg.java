...
public class ListenerMQMsg {	
	...
	public void getMessageFromMq() throws InterruptedException {		
		final  String host = "10.22.93.120";
		final String qManager = "RU.FTS.GNIVC";
		final int port = 1414;
		final String channel = "AT.SVRCONN";
		final String queue = "AT.INCOME";
